...
language. The comparison covers supported cryptographic algorithms, key sizes, hash operations, 
methods for generation of cryptographic keys, methods for work with X.509 certificates and higher 
level protocols such as SSL/TLS. 
