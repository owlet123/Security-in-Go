...
\thesissetup{
    ...
    keywords      = {Security, Certificate, TLS, TLS\_PSK, Pre-shared key, Language Go, Language C, Cgo, OpenSSL},
    TeXkeywords   = {Security, Certificate, TLS, TLS\_PSK, Pre-shared key, Language Go, Language C, Cgo, OpenSSL},
    bib           = example.bib,
}
\thesislong{abstract}{
...
\cite{dostalek2016velky}. %For the needs of the Internet, there is created an Internet profile of X.509 in the relevant RFC. Current Internet profile certificate is standard RFC-5280 \cite{dostalek2016velky}.
